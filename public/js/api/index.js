...
export async function loadLatestNews() {
    ...
    console.log('[loadLatestNews] container:', container);
...
export function loadNewsPage() {
  // Защитна проверка: само ако сме на news.html
  if (!document.getElementById('news-single-section') && !document.getElementById('news-list-section')) {
    return; // ⛔ Прекъсваме ако не сме на тази страница
  }
